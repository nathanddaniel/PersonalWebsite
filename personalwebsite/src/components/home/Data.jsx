...
const Data = () => {
  return (
    <div className="home__data">
        <h1 className="home__title">Nathan Daniel
        <svg
                  width="36"
                  height="36"
                  viewBox="0 0 48 48"
        ...
        <h3 className="home__subtitle">Software Engineering Student</h3>
        <p className="home__description">I'm a software engineering student at Queen's University, passionate about software applications, 
        machine learning, and improving the world!</p>
